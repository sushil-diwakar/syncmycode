...
const Home = () => {
    ...
    const handleStartGuestCode = async () => {
        ...
        try {
            // Initialize code room in backend
            ...
            if (res.ok) {
                ...
                // Fallback to client navigation anyway
                navigate(`/${uniqueId}`);
            }
        } catch (error) {
                ...
                <div className="row align-items-center g-5 min-vh-75 mt-2">
                    <div className="col-lg-6 text-start">
                        ...
                        <div className="d-flex flex-column flex-sm-row gap-3 pt-2">
                            ...
                            <Link to="/signup" className="btn btn-secondary-custom px-4 py-3 fs-6 d-flex align-items-center justify-content-center">
                                Create Account
                            </Link>
                        </div>
                    ...
                    {/* Premium Interactive SVG Illustration representing a code editor with glowing avatars */}
